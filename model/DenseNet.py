...
class DenseNet(nn.Module):
    def __init__(self, init_channels=64, growth_rate=32, blocks=[6, 12, 24, 16],num_classes=100):
...
def DenseNet121(class_num=100):
    return DenseNet(init_channels=64, growth_rate=32, blocks=[6, 12, 24, 16], num_classes=class_num)

def DenseNet169(class_num=100):
    return DenseNet(init_channels=64, growth_rate=32, blocks=[6, 12, 32, 32], num_classes=class_num)

def DenseNet201(class_num=100):
    return DenseNet(init_channels=64, growth_rate=32, blocks=[6, 12, 48, 32], num_classes=class_num)

def DenseNet264(class_num=100):
    return DenseNet(init_channels=64, growth_rate=32, blocks=[6, 12, 64, 48], num_classes=class_num)
